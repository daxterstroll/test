class TypeCertificatesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @type_certificate.update(type_certificate_params)
        format.html { redirect_to @type_certificate, notice: 'Type certificate was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to type_certificates_url, notice: 'Type certificate was successfully destroyed.' }
  ...
  private
    ...
    def type_certificate_params
      params.require(:type_certificate).permit(:name)
    end
end
