...
class ClassSchedulesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create class_schedule" do
    assert_difference('ClassSchedule.count') do
      post class_schedules_url, params: { class_schedule: { attachment: @class_schedule.attachment } }
    end
  ...
  test "should update class_schedule" do
    patch class_schedule_url(@class_schedule), params: { class_schedule: { attachment: @class_schedule.attachment } }
